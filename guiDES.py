...
class gui(tk.Frame):
    def __init__(self, window):
        ...
        self.entry_text_ent = tk.Entry(window, font = 'Arial 14', width = 15)
        self.crypt_key_ent = tk.Entry(window, font = 'Arial 14', width = 30)
        self.crypt_key_ctrl_bit_ent = tk.Entry(window, font = 'Arial 14', width = 30)
        ...
        self.entry_text_sys_ent = tk.Entry(self.lblFrame2, font = 'Arial 14', width = 40)
        self.crypt_key_sys_ent = tk.Entry(self.lblFrame2, font = 'Arial 14', width = 40)
        self.crypt_key_ctrl_bit_sys_ent = tk.Entry(self.lblFrame2, font = 'Arial 14', width = 40)
        ...
        self.lblFrame1.grid(row = 2, column = 0, columnspan = 5, sticky = 'w', pady = 15)
        ...
        self.lblFrame2.grid(row = 3, column = 0, columnspan = 5, sticky = 'w')
        ...
        self.lblFrame3.grid(row = 4, column = 0, columnspan = 5, sticky = 'w', pady = 10)
