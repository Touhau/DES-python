...
# двочная битовая строка которую запихиваешь должна делиться на 8 иначе пиздец всё поломается
# шестнадцатиричная строка которую запихиваешь должна делиться на 2 иначе смотри выше
# вроде всё
# 
